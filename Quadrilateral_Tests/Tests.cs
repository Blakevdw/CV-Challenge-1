...
namespace Quadrilateral_Tests
{
	...
	public class Tests
	{
		...
		public void Init()
		{
			...
			sq3 = new Square("Yellow", 5);
			rec3 = new Rectangle("Yellow", 5, 10);

			sq4 = new Square("Orange", 15);
			rec4 = new Rectangle("Gold", 4, 6);

			sq5 = new Square("Purple", 7);
			rec5 = new Rectangle("Brown", 9, 7);
